...
static $typeArray = array('lecturer_id' => 'int','society_name' => 'varchar','office_held' => 'varchar','session_period' => 'varchar','category' => 'varchar','date_created' => 'timestamp');
...
function getLecturer_idFormField($value = ''){
 ...
 function getSession_periodFormField($value = ''){
	return "<div class='form-group'>
				...
				<textarea name='session_period' id='session_period' class='form-control' placeholder='e.g:2012/2013 session till date' required>$value</textarea>
			</div>";
} 
