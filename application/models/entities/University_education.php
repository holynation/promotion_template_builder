...
defined("BASEPATH") OR exit("No direct script access allowed");
	...
	/**
	* This class  is automatically generated based on the structure of the table. And it represent the model of the university_education table.
	*/ 

class University_education extends Crud {

protected static $tablename = "University_education"; 
...
static $typeArray = array('lecturer_id' => 'int','university_name' => 'varchar','start_date' => 'varchar','end_date' => 'varchar','location' => 'varchar','date_created' => 'timestamp');
/*this is a dictionary that map a field name with the label name that will be shown in a form*/ 
static $labelArray = array('ID' => '','lecturer_id' => '','university_name' => '','start_date' => '','end_date' => '','location' => 'Location of University','date_created' => '');
...
static $tableAction = array('delete' => 'delete/university_education', 'edit' => 'edit/university_education');
...
function getLecturer_idFormField($value = ''){
 ...
 function getUniversity_nameFormField($value = ''){
	return "<div class='form-group'>
				<label for='university_name'>University Name</label>
				<input type='text' name='university_name' id='university_name' value='$value' class='form-control' placeholder='The name in full' required />
			</div>";
} 
 ...
 function getLocationFormField($value = ''){
	return "<div class='form-group'>
				<label for='location'>Location of University</label>
