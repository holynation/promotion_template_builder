...
defined("BASEPATH") OR exit("No direct script access allowed");
	...
	/**
	* This class  is automatically generated based on the structure of the table. And it represent the model of the professional_qualifications table.
	*/ 

class Professional_qualifications extends Crud {
...
static $typeArray = array('lecturer_id' => 'int','qualifications' => 'varchar','school_granted' => 'varchar','date_granted' => 'varchar','date_created' => 'timestamp');
/*this is a dictionary that map a field name with the label name that will be shown in a form*/ 
static $labelArray = array('ID' => '','lecturer_id' => '','qualifications' => 'Professional Qualifications','school_granted' => 'Granting Body','date_granted' => '','date_created' => '');
...
static $tableAction = array('delete' => 'delete/professional_qualifications', 'edit' => 'edit/professional_qualifications');
...
function getLecturer_idFormField($value = ''){
 ...
 function getQualificationsFormField($value = ''){
	return "<div class='form-group'>
				<label for='qualifications'>Professional Qualifications</label>
				<input type='text' name='qualifications' id='qualifications' value='$value' class='form-control' required />
			</div>";
} 
 function getSchool_grantedFormField($value = ''){
	return "<div class='form-group'>
				<label for='school_granted'>Granting Body</label>
